...
Phase 3 brings Vole to parity with OpenClaw's core prompt assembly concept: each model call receives a structured context document with explicit, named sections. Skills, tools, and safety guidance are first-class sections, not afterthoughts.
