...
It wires CLI-visible commands to runtime, config, workspace prompt loading, and durable session/message/trace dependencies without owning agent planning, prompt assembly, tools, or permission policy.
