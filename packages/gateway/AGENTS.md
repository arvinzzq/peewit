...
All registry operations need unit tests. Use fixed timestamps and capability constants from `@vole/adapters`. No real API keys or file system access needed — the gateway is a pure in-memory registry.
